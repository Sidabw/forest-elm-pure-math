package com.brew.home.geekbang.p1sortAsearch.sort.s9radix;

import java.util.Arrays;

/**
 * 原始代码来自：https://www.javatpoint.com/radix-sort，除了变量名、数组声明方式等不影响结果的修改外，
 *
 * <p> 原始代码中        int[] sorted = new int[n + 1]; 改为了 new int[n]
 * <p> 因为计数排序就是这样，n + 1实在是没道理。
 *
 * @author shaogz
 */
