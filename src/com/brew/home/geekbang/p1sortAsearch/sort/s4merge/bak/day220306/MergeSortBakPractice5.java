package com.brew.home.geekbang.p1sortAsearch.sort.s4merge.bak.day220306;
 ...
 * @author shaogz
 */
public class MergeSortBakPractice5 {
    ...
    void m2sa(int[] arr, int left, int mid, int right, int[] tmp) {
